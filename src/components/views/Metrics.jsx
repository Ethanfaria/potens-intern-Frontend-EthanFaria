...
export default function Metrics() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-4">
        <h2 className="text-lg font-bold text-teal-900 tracking-wide">{t.liveMetrics}</h2>
        <p className="text-xs text-slate-500 mt-0.5">{t.realTime}</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-xs font-mono text-slate-500 uppercase tracking-widest">{t.vehiclesOffRadar}</p>
            <p className="text-3xl font-bold text-slate-800 mt-1">3</p>
            <p className="text-xs text-slate-400 mt-1">Last seen Khopoli · 07:09</p>
          </div>
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-xs font-mono text-slate-500 uppercase tracking-widest">{t.paymentsQueued}</p>
            <p className="text-3xl font-bold text-slate-800 mt-1">14</p>
            <p className="text-xs text-slate-400 mt-1">{t.neftRetry}</p>
          </div>
        </div>
